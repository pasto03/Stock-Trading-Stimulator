"""
Adjustments were made to accommodate the state returned by the simulation environment
"""
...
class DQNAgent:
    ...
    def replay(self, memory, batch_size):
        ...
        # 对其中的各个参数进行变换
        states = torch.tensor(states, dtype=torch.float32).to(self.device)  # [state_dim, batch_size]
